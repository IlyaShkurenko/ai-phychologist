...
const messages: Record<Locale, TranslationDict> = {
  ru: {
    ...
    "app.tab.analyzer": "Анализатор",
    "app.tab.prompts": "Prompts",
    "app.disconnect": "Отключить Telegram",
    "app.clearSession": "Очистить данные сессии",
    "prompts.title": "Управление промптами",
    "prompts.theme.gaslighting": "Газлайтинг",
    "prompts.step1": "Шаг 1",
    "prompts.step2": "Шаг 2",
    "prompts.step3": "Шаг 3",
    "prompts.chat": "Чат",
    "prompts.chatNotSelected": "Чат не выбран",
    "prompts.dateRange": "Диапазон дат",
    "prompts.editorLabel": "Промпт для теста",
    "prompts.saveVersion": "Сохранить новую версию",
    "prompts.testStep": "Тестировать шаг",
    "prompts.reload": "Обновить",
    "prompts.testOutput": "Окно вывода теста",
    "prompts.noOutputYet": "Пока нет результатов теста.",
    "prompts.testing": "Тестируем промпт...",
    "prompts.versions": "Версии шага",
    "prompts.loading": "Загрузка версий...",
    "prompts.empty": "Версий пока нет.",
    "prompts.version": "Версия",
    "prompts.active": "Активная",
    "prompts.loadToEditor": "В редактор",
    "prompts.setActive": "Сделать активной",
    "prompts.status.loadFailed": "Не удалось загрузить промпты",
    "prompts.status.emptyDraft": "Промпт не может быть пустым",
    "prompts.status.saved": "Новая версия сохранена",
    "prompts.status.saveFailed": "Не удалось сохранить новую версию",
    "prompts.status.activated": "Активная версия обновлена",
    "prompts.status.activateFailed": "Не удалось активировать версию",
    "prompts.status.testing": "Тестируем промпт...",
    "prompts.status.testDone": "Тест шага выполнен",
    "prompts.status.testFailed": "Тест шага завершился ошибкой",
    ...
    "chatView.exportRangeTxt": "Экспорт диапазона (.txt)",
    ...
    "status.exporting": "Экспорт диапазона...",
    "status.exportComplete": "Экспорт завершен.",
    "status.exportFailed": "Не удалось экспортировать диапазон",
  ...
  en: {
    ...
    "app.locale.en": "English",
    "app.tab.analyzer": "Analyzer",
    "app.tab.prompts": "Prompts",
    "app.disconnect": "Disconnect Telegram",
    "app.clearSession": "Clear session data",
    "prompts.title": "Prompt Management",
    "prompts.theme.gaslighting": "Gaslighting",
    "prompts.step1": "Step 1",
    "prompts.step2": "Step 2",
    "prompts.step3": "Step 3",
    "prompts.chat": "Chat",
    "prompts.chatNotSelected": "Chat is not selected",
    "prompts.dateRange": "Date range",
    "prompts.editorLabel": "Prompt for test",
    "prompts.saveVersion": "Save new version",
    "prompts.testStep": "Test step",
    "prompts.reload": "Reload",
    "prompts.testOutput": "Test output",
    "prompts.noOutputYet": "No test output yet.",
    "prompts.testing": "Testing prompt...",
    "prompts.versions": "Step versions",
    "prompts.loading": "Loading versions...",
    "prompts.empty": "No versions yet.",
    "prompts.version": "Version",
    "prompts.active": "Active",
    "prompts.loadToEditor": "Load to editor",
    "prompts.setActive": "Set active",
    "prompts.status.loadFailed": "Failed to load prompts",
    "prompts.status.emptyDraft": "Prompt cannot be empty",
    "prompts.status.saved": "New version saved",
    "prompts.status.saveFailed": "Failed to save new version",
    "prompts.status.activated": "Active version updated",
    "prompts.status.activateFailed": "Failed to activate version",
    "prompts.status.testing": "Testing prompt...",
    "prompts.status.testDone": "Step test completed",
    "prompts.status.testFailed": "Step test failed",
    ...
    "chatView.exportRangeTxt": "Export range (.txt)",
    ...
    "status.exporting": "Exporting range...",
    "status.exportComplete": "Export complete.",
    "status.exportFailed": "Failed to export range",
